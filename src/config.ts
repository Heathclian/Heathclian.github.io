...
export const siteConfig: SiteConfig = {
	title: "Heathclian's Blog",
	subtitle: "My notes on books, ideas, and everything worth learning.",
	...
	favicon: [
		// Leave this array empty to use the default favicon
		 {
		   src: '/favicon/note.png',    // Path of the favicon, relative to the /public directory
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/Heathclian", // Internal links should not include the base path, as it is automatically added
